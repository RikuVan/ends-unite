...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [11, 20], notes: "Kotlin" }
  ]}
/>

---

### Friction in contributing at every end

<div>SOCIAL FACTORS</div>

<UnorderedList>
  <Appear>
    <li>team size & skill imbalances</li>
    <li>lack of time or willingness to learn and make mistakes</li>
    <li>team processes & dynamics</li>
...
<div>TECHNICAL FACTORS</div>

<UnorderedList>
  <Appear>
    <li>languages & platforms</li>
    <li>frameworks & build tools</li>
    <li>
      <Hi>INTERNAL APIs 🤔</Hi>
    </li>
  </Appear>
...
### Wouldn't it be handy if we used the abstractions at every 'end' of the stack?
